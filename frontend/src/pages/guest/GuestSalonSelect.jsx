...
import '../customer/SalonSelect.css'

function GuestSalonSelect() {
  ...
  return (
    <div className="container">
      <div className="page-header">
        <h1>Browse Salons</h1>
        <p>Explore services — login to book appointments</p>
      </div>
        ...
        {!loading && salons.map((salon) => {
          ...
          return (
            <div
              ...
              onClick={() => navigate(`/guest/dashboard/${salon.id}`)}
            >
...
export default GuestSalonSelect
